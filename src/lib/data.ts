...
export const services = [
  {
    ...
    description: "Penetration testing, vulnerability assessments, and security audits for Zimbabwean businesses. A real pentest means I actively try to break into your systems — the same way a criminal would — then give you a written report of everything I found and how to fix it.",
  ...
  },
  {
    ...
    description: "I build websites that load fast, rank on Google, and actually convert visitors into leads. Built with Next.js. Delivered in under 2 weeks for most projects.",
  ...
  },
  {
    ...
    description: "Business management systems, internal tools, and web applications built to your exact spec. I scope it, build it, and hand it over — no vendor lock-in.",
  ...
  },
  {
    ...
    shortDesc: "Android and iOS apps built for real users, not demo screenshots.",
    description: "Cross-platform mobile apps using React Native. One codebase, both platforms. I handle design, development, and App Store submission.",
  ...
  },
  {
    ...
    shortDesc: "Something broken? I'll fix it and tell you why it broke.",
    description: "Remote and on-site technical support for businesses in Harare. Systems, networks, software — if it's broken I'll sort it out and explain what happened.",
    features: ["Remote Support", "On-Site (Harare)", "System Maintenance", "Network Troubleshooting", "Hardware Support", "Staff Training"],
