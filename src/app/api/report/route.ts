...
export async function POST(req: Request) {
  ...
  // HTTPS reachability + capture headers/html
  try {
  ...
  // Security headers
  const headerDefs: { id: string; key: string; name: string; weight: number; fix: string }[] = [
  ...
  // Email anti-spoofing: SPF + DMARC (public DNS)
  ...
  // Top findings: failed checks, worst (highest weight / severity) first — used for the ungated teaser.
