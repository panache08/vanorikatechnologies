...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/security-index`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${base}/tools/spf-dmarc-generator`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/email-header-analyzer`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/password-generator`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/tech-stack`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/attack-surface`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/security-quiz`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/tools/password-breach`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/breach-cost`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/cookies`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/tls`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/blog`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${base}/security-glossary`, lastModified: now, changeFrequency: "monthly", priority: 0.5 },
    { url: `${base}/book`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/monitoring`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${base}/tools/badge`, lastModified: now, changeFrequency: "monthly", priority: 0.5 },
