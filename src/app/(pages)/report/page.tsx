...
export const metadata: Metadata = {
  ...
  description:
    "Scan your website and get a free 5-page security report as a branded PDF — SSL, security headers, email spoofing (SPF/DMARC), and Data Protection Act 2021 exposure, with plain-English fixes.",
  openGraph: {
