...
export const metadata: Metadata = {
  ...
  description:
    "Cybersecurity for Zimbabwean clinics and healthcare providers — protect patient records, comply with the Data Protection Act, and keep systems running. Audits and penetration testing from Harare.",
};
...
export default function HealthcarePage() {
  return (
    <IndustryLanding
      ...
      risks={[
        { title: "Patient record exposure", desc: "Medical histories and personal details are extremely sensitive — and a legal liability if leaked." },
