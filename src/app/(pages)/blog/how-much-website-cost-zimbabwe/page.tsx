...
export default function Page() {
  return (
    ...
    >
      ...
      <ul>
        <li><strong>$250 – $400</strong> — a clean 5-page brochure site (home, about, services, contact, one extra). Right for most small businesses.</li>
        <li><strong>$700 – $1,200</strong> — a larger site with a content dashboard you can edit yourself, a blog, or a small online store.</li>
        <li><strong>$1,500 – $3,000+</strong> — a custom web application: logins, dashboards, bookings, payment integration, or anything bespoke.</li>
      </ul>
      <p>
      ...
      <ul>
        <li><strong>Domain name</strong> — a <strong>.co.zw</strong> is registered through ZISPA and renews yearly; a <strong>.com</strong> runs about $10–15 a year. You should own this, not your developer.</li>
      ...
      <p>Whatever you pay, a professional website should include — as standard, not as extras:</p>
      <ul>
      ...
      <p>
        For most small and medium businesses in Zimbabwe, a proper website is a <strong>$300–$800 once-off</strong> investment, plus a
