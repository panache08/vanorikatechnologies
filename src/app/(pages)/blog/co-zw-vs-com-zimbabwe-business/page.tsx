  ...
  return (
    <ArticleShell
      ...
      cta={{
        ...
        text: "We handle domain registration, hosting, and the full setup as part of every website project. We&apos;ll also advise on the right domain for your specific business.",
        label: "Talk to Us",
    ...
    >
      ...
      <ul>
        <li><strong>.com</strong>: roughly $10 to $15 a year, registered through any international registrar. Quick and familiar.</li>
      ...
      <p>
        ...
        you&apos;re local-first, .com if you&apos;re global-first), then register the other one too and redirect it to your main site.
      </p>
      <p>
