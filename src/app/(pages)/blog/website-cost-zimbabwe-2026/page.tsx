...
export const metadata: Metadata = {
  ...
  description:
    "Website quotes in Zimbabwe range from $50 to $5,000. Here's what actually drives the price — and a realistic cost guide for Zimbabwean businesses in 2026.",
};
...
export default function Page() {
  return (
    ...
    >
      ...
      <ul>
        <li><strong>Basic business website (3–5 pages):</strong> roughly $300–$600. Mobile-ready, contact form, basic SEO.</li>
        <li><strong>Business site with CMS / e-commerce:</strong> roughly $600–$2,000. You can edit content yourself, sell products, take payments.</li>
      ...
      <p>
        ...
        built properly, secured, and supported — and get the price in writing first.
      </p>
    </ArticleShell>
  );
}
