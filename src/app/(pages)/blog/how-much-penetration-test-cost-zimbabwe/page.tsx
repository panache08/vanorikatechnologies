...
export default function Page() {
  return (
    ...
    >
      ...
      <ul>
        <li><strong>$300 to $900</strong>: a single website or web application. The most common engagement for local SMEs.</li>
        <li><strong>$1,000 to $2,500</strong>: a larger web app plus your external (internet-facing) network and email setup.</li>
        <li><strong>$2,500+</strong>: full scope across network, web, phishing simulation, and internal testing for bigger or regulated organisations.</li>
      </ul>
      <p>
