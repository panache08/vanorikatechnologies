...
const terms: { term: string; def: string }[] = [
  ...
  { term: "CSP (Content Security Policy)", def: "A security header that controls where a page is allowed to load scripts and content from — a strong defence against content injection." },
  { term: "HSTS", def: "A header that forces browsers to always use HTTPS for your site, preventing downgrade attacks." },
  { term: "Attack surface", def: "Everything about you that's reachable and could be attacked — your website, subdomains, exposed services, email and more." },
