...
export const metadata: Metadata = {
  ...
  description:
    "Mobile app development for Zimbabwe businesses — Android and cross-platform apps built with React Native. Design, development, and app store deployment handled end to end. From $800.",
};
  ...
  return (
    <ServiceLanding
      ...
      features={[
        ...
        { icon: Layers, title: "Cross-Platform (React Native)", desc: "One codebase, both Android and iOS — faster to build and cheaper to maintain." },
