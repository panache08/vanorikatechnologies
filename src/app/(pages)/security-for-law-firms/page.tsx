  ...
  return (
    <IndustryLanding
      ...
      risks={[
        ...
        { title: "Data Protection Act exposure", desc: "Holding sensitive personal data raises your compliance bar, along with the penalties for a mishandled breach." },
        { title: "Weak document portals", desc: "Client portals and shared drives are often set up once and never security-tested." },
        { title: "Ransomware", desc: "Locking up a firm's case files is devastating. Attackers know firms are pressured to pay." },
