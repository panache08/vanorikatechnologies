...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 px-4 py-3 bg-[#25D366] rounded-2xl shadow-[0_8px_30px_rgba(37,211,102,0.4)] group"
      ...
      <span className="text-white text-sm font-semibold pr-1 hidden sm:block">Chat with us</span>
      {/* Pulse ring */}
