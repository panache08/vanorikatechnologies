...
const reasons = [
  ...
  { icon: DollarSign, title: "Affordable Premium Quality", desc: "Enterprise-grade solutions at prices that make sense for businesses. No hidden fees, ever.", color: "text-cyan", bg: "bg-cyan/10 group-hover:bg-cyan/18" },
  ...
  { icon: Code2, title: "Modern Technology", desc: "We use the latest, most powerful technologies to ensure your solution is future-proof.", color: "text-electric", bg: "bg-electric/10 group-hover:bg-electric/18" },
  { icon: HeartHandshake, title: "Long-Term Partnership", desc: "We don't disappear after launch. We're your dedicated technology partner for the long haul.", color: "text-cyan", bg: "bg-cyan/10 group-hover:bg-cyan/18" },
];
    ...
    <section className="py-28 relative overflow-hidden bg-background">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader badge="WHY US" title="The PanasheTech" titleGradient="Difference"
          subtitle="We're not just a vendor — we're a technology partner invested in your long-term success." />
